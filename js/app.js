...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    /*  */
    const satr=product.rating.rate;
    /*  */
    const div = document.createElement("div");
    div.classList.add("product");
    div.innerHTML = `<div class="single-product bg-cyan-200 ms-1">
      <div>
    <img class="product-image" src='${product.image}'></img>
      ...
      <div class="rating text-center">
        <h4 class="text-center">Rating Overview</h4>

        <div class="rat"><span id="RattingAvg">${product.rating.rate}</span>/5</div>

        <!--  <div id="allstar">
      <span class="fa fa-star star1 star12 star125 Warning"></span>
      <span class="fa fa-star  star2 star12 star225"></span>
      <span class="fa fa-star  star3 star35 star325"></span>
      <span class="fa fa-star star4 star45 star425"></span>
      <span class="fa fa-star star5 star55 star525"></span>
      </div> -->
      <!-- Total Person -->
      <p id="totalPerson">${product.rating.count}</p>
      </div>


      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn">add to cart</button>
      <button id="details-btn" class="btn detailBtn">Details</button></div>
      `;
...
const AvgRati = () => {
  const mmm =document.getElementById("RattingAvg").innerText;
  console.log(mmm);
};
/*  */
let count = 0;
